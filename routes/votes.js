...
///////////////////////////////////////////////////////////////////////////////////////////
/**
 * @api {post} /api/votes Create a vote
 * @apiName CreateVote
 * @apiGroup Vote
 * @apiVersion 1.0.0
 ...
 * @apiParam (Request body) {Boolean{[0 = false = down | 1 = true = up]}} type Vote type, up or down 
 * @apiParam (Request body) {ObjectId} userId The user id
 * @apiParam (Request body) {ObjectId} benchId The bench id
 */

/**
 * @apiDefine VoteInResponseBody
 * @apiSuccess (Response body) {String} id The unique identifier of the vote (generated by mongo)
 * @apiSuccess (Response body) {Boolean} type Vote type, up or down
 * @apiSuccess (Response body) {String} voteDate The date of the vote (default)
